...
int SpiderModel::rotateandsetpoints(double thetax, double thetay, double thetaz)
{
...
int SpiderModel::draw(SDL_Surface *screen, int offsetx, int offsety)
{
...
{
	draw(screen,offsetx,offsety);//right leg
	draw(screen,offsetx+10,offsety+10);//right leg
	draw(screen,offsetx+5,offsety+10);//right leg
	draw(screen,offsetx+15,offsety+10);//right leg
	rotateandsetpoints(0,3.14,0);
	draw(screen,offsetx,offsety);//left leg
	draw(screen,offsetx+10,offsety+10);//left leg
	draw(screen,offsetx+5,offsety+10);//left leg
	draw(screen,offsetx+15,offsety+10);//left leg
	return 0;
}
